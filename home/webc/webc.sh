...
AGA_mode=kiosk
. "$AGA_mod_file"
wget -N --timeout=10 "${install_base_url}/.xscreensaver?screenW=${AGA_screenW}&screenH=${AGA_screenH}&mode=${AGA_mode}" -O /home/webc/.xscreensaver.tmp
 grep -qs "XScreenSaver Preferences File" /home/webc/.xscreensaver.tmp && cp /home/webc/.xscreensaver.tmp /home/webc/.xscreensaver
xscreensaver &
# AGA end
